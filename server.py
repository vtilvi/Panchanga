...
app = FastAPI()
# Ensure your 'templates' folder is in the same directory as server.py
...
def lahiri_ayanamsa(t):
    # Standard Chitra Paksha Ayanamsa formula
    jd = 2451545 + t.ut
...
def get_lon(body, dt):
    # Adjusting for IST (UTC+5:30) as used in Goa-based calculations
...
# -----------------------------
# ROUTES (FIXED FOR MODERN FASTAPI)
# -----------------------------
...
def home(request: Request):
    ...
    # Modern Starlette/FastAPI syntax using explicit keywords
